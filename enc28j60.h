...
// ERRATTA make receive buffer first! (IE workaround #3)
#define TXSTART_INIT   	0x1a00	// start TX buffer at 0   (+++ should this be (n+1)-8191) ??
...
#define	MAX_FRAMELEN	1518	// maximum ethernet frame length 1518!
...
#else
/*
#define ENC28J60_MAC0 0x6
#define ENC28J60_MAC1 0x5
#define ENC28J60_MAC2 0x4
#define ENC28J60_MAC3 0x3
#define ENC28J60_MAC4 0x2
#define ENC28J60_MAC5 0x1
*/

/* nchip has the number 00-00-14   (hex)		NETRONIX */

#define ENC28J60_MAC0  0
#define ENC28J60_MAC1  0
#define ENC28J60_MAC2 0x14
#define ENC28J60_MAC3 'u'
#define ENC28J60_MAC4 'N'
