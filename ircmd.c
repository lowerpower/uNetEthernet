...
#define CMD_DHCP			'D'				//  D   =	DHCP Command
#define CMD_INTERIGATE		'I'				//  I	=   Returns link status, OK, Link Down, or DHCP_Fail
#define CMD_ETH_STAT		'Y'		
#define CMD_ETH_RST			'Z'
